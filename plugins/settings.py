...
from Nihal.config import (BANNED_USERS, CLEANMODE_DELETE_MINS,
                    MUSIC_BOT_NAME, OWNER_ID)
from Nihal.strings import get_command
from Nihal import app
from Nihal.utils.database import (add_nonadmin_chat,
