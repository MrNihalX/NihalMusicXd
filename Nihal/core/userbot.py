    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("Nihal_Logo")
            except:
                pass
            assistants.append(1)
            ...
            LOGGER(__name__).info(
                f"🌷 ǫᴜᴇᴇɴ ᴀssɪsᴛᴀɴᴛ sᴛᴀʀᴛᴇᴅ ᴀs {self.one.name}"
            )
            try:
                await self.one.send_message(
                    config.LOG_GROUP_ID, f"🌷 ǫᴜᴇᴇɴ ✵ ʙᴏᴛ ᴀssɪsᴛᴀɴᴛ  1 sᴛᴀʀᴛᴇᴅ 🌺.\n\n✅ ɴᴀᴍᴇ :**{self.one.name}\n👑 ᴜsᴇʀɴᴀᴍᴇ : @{self.one.username}\n🌷 ɪᴅ : {self.one.id}"
                )
            except:
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("Nihal_Logo")
            except:
                pass
            assistants.append(2)
            ...
            try:
                await self.two.send_message(
                    config.LOG_GROUP_ID, f"🌷 ǫᴜᴇᴇɴ ✵ ʙᴏᴛ ᴀssɪsᴛᴀɴᴛ 2 sᴛᴀʀᴛᴇᴅ.\n\n✅ ɴᴀᴍᴇ :{self.two.name}\n👑 ᴜsᴇʀɴᴀᴍᴇ : @{self.two.username}\n🌷 ɪᴅ : {self.two.id}"
                )
            except:
                LOGGER(__name__).error(
                ...
                sys.exit()
            LOGGER(__name__).info(
                f"🌷 ǫᴜᴇᴇɴ ✵ ʙᴏᴛ ᴀssɪsᴛᴀɴᴛ  2 sᴛᴀʀᴛᴇᴅ  ᴀs {self.two.name}"
            )
        if config.STRING3:
            await self.three.start()
            try:
                await self.three.join_chat("AAPLI_YARRI")
                await self.three.join_chat("Nihal_Logo")
            except:
                pass
            assistants.append(3)
            ...
            try:
                await self.three.send_message(
                    config.LOG_GROUP_ID, f"🌷ǫᴜᴇᴇɴ ✵ ʙᴏᴛ ᴀssɪsᴛᴀɴᴛ 3 sᴛᴀʀᴛᴇᴅ .\n\n✅ ɴᴀᴍᴇ :{self.three.name}\n👑 ᴜsᴇʀɴᴀᴍᴇ : @{self.three.username}\n🌷 ɪᴅ : {self.three.id}"
                )
            except:
                LOGGER(__name__).error(
                ...
                sys.exit()
            LOGGER(__name__).info(
                f"🌷 ǫᴜᴇᴇɴ ✵ ʙᴏᴛ ᴀssɪsᴛᴀɴᴛ 3 sᴛᴀʀᴛᴇᴅ ᴀs {self.three.name}"
            )
        if config.STRING4:
            await self.four.start()
            try:
                await self.four.join_chat("AAPLI_YARRI")
                await self.four.join_chat("Nihal_Logo")
            except:
                pass
            assistants.append(4)
            ...
            try:
                await self.four.send_message(
                    config.LOG_GROUP_ID, f"🌷 ǫᴜᴇᴇɴ ✵ ʙᴏᴛ ᴀssɪsᴛᴀɴᴛ 4 sᴛᴀʀᴛᴇᴅ  ᴀs .\n\n✅ ɴᴀᴍᴇ :{self.four.name}\n👑 ᴜsᴇʀɴᴀᴍᴇ : @{self.four.username}\n🌷 ɪᴅ : {self.four.id}"
                )
            except:
                LOGGER(__name__).error(
                ...
                sys.exit()
            LOGGER(__name__).info(
                f"🌷 ǫᴜᴇᴇɴ ✵ ʙᴏᴛ ᴀssɪsᴛᴀɴᴛ  4 sᴛᴀʀᴛᴇᴅ {self.four.name}"
            )
        if config.STRING5:
            await self.five.start()
            try:
                await self.five.join_chat("AAPLI_YARRI")
                await self.five.join_chat("Nihal_Logo")
            except:
                pass
            assistants.append(5)
            ...
            try:
                await self.five.send_message(
                    config.LOG_GROUP_ID, f"🌷 ǫᴜᴇᴇɴ ✵ ʙᴏᴛ ᴀssɪsᴛᴀɴᴛ 5 sᴛᴀʀᴛᴇᴅ  ᴀs .\n\n✅ ɴᴀᴍᴇ :{self.five.name}\n👑 ᴜsᴇʀɴᴀᴍᴇ:** @{self.five.username}\n🌷 ɪᴅ : {self.five.id}"
                )
            except:
                LOGGER(__name__).error(
                ...
                sys.exit()
            LOGGER(__name__).info(
                f"🌷 ǫᴜᴇᴇɴ ✵ ʙᴏᴛ ᴀssɪsᴛᴀɴᴛ 5 sᴛᴀʀᴛᴇᴅ {self.five.name}"
            )
